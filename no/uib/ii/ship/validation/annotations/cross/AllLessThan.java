...
/**
 * Tests that at least all the values are below the given limit.
 *
 * @author fma042
 */
...
public @interface AllLessThan {
	 ...
	 * The Class Tester.
	 */
	public static class Tester implements ICrossTester<AllLessThan,Integer>{

		/* (non-Javadoc)
		 * @see no.uib.ii.ship.validation.ICrossTester#runTest(java.lang.annotation.Annotation, java.util.ArrayList)
		 */
		public boolean runTest(AllLessThan c, List<Integer> v) throws ValidationException {
			for (int i:v)
